<div class="flex flex-col items-center justify-center pt-20 bg-orange-200">
    ...
    @if($showButton)
    <a href="#" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-orange-500 hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-orange-500 rounded-lg dark:bg-orange-500 dark:focus:ring-orange-500 transition-transform duration-300 transform hover:scale-110 mb-8">
        {{ $buttonText }}
    </a>
    @endif
</div>
